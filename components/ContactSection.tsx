  ...
  return (
    <section className="section-pad flex flex-col gap-6 border-t border-white/15 lg:flex-row lg:items-center lg:justify-between" id="contact">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap lg:justify-end">
        <a className="rounded-full border border-white/15 px-4 py-3 text-ink/80 transition hover:border-gold/50 hover:text-ink" href="mailto:hello@ajcmedia.ca">ajcmedia888@gmail.com</a>
        <a className="rounded-full border border-white/15 px-4 py-3 text-ink/80 transition hover:border-gold/50 hover:text-ink" href="tel:+16045550188">(778) 883-4378</a>
